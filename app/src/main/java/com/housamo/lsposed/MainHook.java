 ...
 *   2. 确认是 Housamo (com.lifewonders.tokyoafterschoolsummoners)
 *   3. System.loadLibrary("housamo_trans") → 触发 JNI_OnLoad
 *   4. JNI_OnLoad 中定位 libil2cpp.so → DobbyHook → 翻译管线就绪
 */
public class MainHook implements IXposedHookLoadPackage {

    private static final String TARGET_PACKAGE = "com.lifewonders.tokyoafterschoolsummoners";
