 ...
 */
final class ContextHistoryPreparer {

    /** Immutable result consumed by the Translation worker. */
    static final class HistoryPreparation {
        final String contextId;
        final String storageName;
        final String capturedSourceHashExcludingScene;
        final boolean requestContextSummary;
        ...
        static HistoryPreparation blocked(HistoryResolution resolution) {
        ...
        static HistoryPreparation noHistory() {
            return ready(
                null,
                null,
                null,
    ...
    ContextHistoryPreparer(SceneContextStore store) {
        if (store == null) {
