...
public final class TranslationApiClient {
    ...
    static final class ListenerFailure extends Exception {
     ...
     */
    static void streamTranslationAttempt(
        TranslationConfig config,
        String body,
        StreamListener listener,
        int attemptNumber
     ...
     */
    static JSONObject sendSummaryRequest(
        TranslationConfig config,
        String body
    ) throws Exception {
    ...
    static boolean isRetryableNetworkException(Throwable error) {
    ...
    static void waitBeforeRetry(int retryNumber)
